<%-- 
    Document   : facullogin
    Created on : 16 Jul, 2019, 11:08:02 PM
    Author     : dinesh
--%>
...
<html>
    ...
    <body>
       <img src="logo1.jpg" height="50" width="50" style="float:left;margin:0;padding:20px 0 0 150px;"> 
		...
		<div id="content">
			<form action="faculvalidate.jsp" onsubmit="return validate()"  >
				<h3>Faculty Login</h3>
				
					
					<input id="uname" type="text" required="" name="username" placeholder="USERNAME"><br>
                                        <label id="lbluser" style="color:red;visibility:hidden">Invalid</label><br>
			
					
					<input id="pass" type="password" required="" name="password" placeholder="PASSWORD"><br><br>
			
                                        <center><input type="submit" name="login" value="LOGIN" > <a href="faculchgpass.jsp" >Change Password</a></center><br><br>
                                        <a href="facultyregistration.jsp">Create one</a>
