...
@WebServlet(name = "faculUploadServlet", urlPatterns = {"/faculUploadServlet"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 10, // 10 MB
        maxFileSize = 1024 * 1024 * 1000, // 1 GB
        maxRequestSize = 1024 * 1024 * 1000)   	// 1 GB
public class faculUploadServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (status > 0) {
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("/facultysucess.jsp");
