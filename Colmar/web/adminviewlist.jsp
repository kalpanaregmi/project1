			...
			<div id="leftmenu">
				...
				<ul>
					...
					<li class="menu item"><a href="viewfeedback.jsp">View Feedback</a></li>
					 <li class="menu item"><a href="adminsendemail.jsp">Send Email</a></li>
    ...
    <center>
        ...
        <table border="2">
            ...
            <tr>
               ...
               <td><a href="deletefaculty.jsp?id=<%=rs.getString("id") %>"><button type="button" class="delete">Delete</button></a></td>
            </tr>
            <%
                }
            %>
